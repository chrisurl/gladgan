...
### Estimation ### 
df = read_rds("data_ignore/df_2024-12.rds")
monYear = substr(Sys.Date(),1,7)
...
### Export ### 
monYear = substr(Sys.Date(),1,7)
entry1 = read_csv("data_ignore/results_2024-12_entry1.csv") %>%
  mutate(entry = "entry_1")
entry2 = read_csv("data_ignore/results_2024-12_entry2.csv")%>%
  mutate(entry = "entry_2")
entry3 = read_csv("data_ignore/results_2024-12_entry3.csv")%>%
