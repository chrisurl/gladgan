...
# Now: a function that processes the subsets of the time series and fit
## arima models, forecast two out-of-sample periods
process_subset <- function(sub_length, df) {
  ...
  # Fit ARIMA model and forecast two out-of-sample periods
  cat(" ..auto.arima \n")
...
# estimation function to process the series
...
# run the estimation function using the estimation_grid
