...
Da ja bereits bekannt ist, dass Deutschland nur bedingt ein guter Prädiktor für Deutschland ist, sollten wir hier wohl weitere Abfragen (weltweit und Europa) einfließen lassen. Im grunde funktioniert es aber und wenn man die Short Term Daten reinarbeitet wird es auch super funktionieren.