...
Not too bad. Compare long and short data results! Maybe some econometric models necessary? More google search data using the terms, those from the short term models and also some county specific! Meaning: For Spain we should also search for (term) + Spain. 