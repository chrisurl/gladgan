...
#for (i in 7:7){
  ...
  t_1 = Sys.time()
  test1 = ts_gtrends(keyword = country, 
                  geo=country_code,
                  time=time_set,
                  category = 67
  )
  ...
  t_1 = Sys.time()
  test2 = ts_gtrends(keyword = country,
                   time=time_set,
                   category = 67
  )
  ...
  t_1 = Sys.time()
  test3 = ts_gtrends(keyword = country, 
                  time=time_set,
                  category = 179
  )
  ...
  t_1 = Sys.time()
  test4 = ts_gtrends(keyword = country, 
                  time=time_set,
                  category = 205
  )
  res1[[4]] = test4 %>%
  ...
  t_1 = Sys.time()
  test5 = ts_gtrends(keyword = country, 
                  time=time_set,
                  category = 378
  )
  res1[[5]] = test5 %>%
  ...
  t_1 = Sys.time()
  test6 = ts_gtrends(keyword = country, 
                  time=time_set,
                  category = 542
  )
  res1[[6]] = test6 %>% 
  ...
  t_1 = Sys.time()
  test7 = ts_gtrends(keyword = country, 
                  time=time_set,
                  category = 1011
  )
  res1[[7]] = test7 %>%
  ...
  write_csv(res_out[[i]], file=paste0(trends_path, "part1_trendecon/country_searches_",country_code,".csv"))
...
#for (i in 7:24){  
  ...
  write_csv(res_in[[i]], file=paste0(trends_path, "part2_trendecon/country_searches_",country_code,".csv"))
